...
export function readStrC16(buffer: ArrayBuffer, ptr: number, maxLength: number = -1) {
    if (maxLength == -1) {
        maxLength = strLenC16(ptr);
    }
